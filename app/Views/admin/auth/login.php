              ...
              <?= $this->include('admin/common/notification'); ?>
                ...
                <form class="pt-3" action="<?= base_url('admin/login'); ?>" method="POST" accept-charset="UTF-8">
                  ...
                  <div class="mt-3 btn-group">
                    <button class="btn btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" >SIGN IN</button>
                    &nbsp;
                    <a class="btn btn-danger btn-lg font-weight-medium auth-form-btn" href="<?=base_url('/')?>">GO BACK</a>
                  </div>
                  <!-- <div class="my-2 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                      <a href="" class="form-check-label text-muted">
